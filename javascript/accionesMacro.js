...
function cargarGasto() {
    class nuevoGasto {
        constructor(categoria, producto, precio) {
            this.categoria = document.getElementById("sArea").value,
            this.producto = document.getElementById("tipoProducto").value,
            this.precio = parseFloat(document.getElementById("precioProducto").value)
        }
    }
    ...
    if (imprimir.categoria != "Categoría" && imprimir.producto != "" && imprimir.precio >= 0 ) {
